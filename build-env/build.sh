...
EXTRA_PKGS="git xxd zsync wget curl libarchive-dev autoconf libtool make gcc libtool libfuse-dev liblzma-dev libglib2.0-dev libssl-dev libinotifytools0-dev liblz4-dev equivs libcairo-dev desktop-file-utils libtool-bin sudo cmake"
